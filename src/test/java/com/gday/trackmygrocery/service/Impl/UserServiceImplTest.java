...
//        assertEquals("admin",userService.getUserById(1).getPwd());
//
//    }
//
//    @Test
...
//
//        LoginParam correctLogin = new LoginParam("sjm@gmail.com", "admin");
...
//    @Test
//    void updateAvatar() {
//        pre = userService.getAvatar(1);
//        userService.updateAvatar("a",1);
//    }
//
//    @Test
//    void getAvatar() {
//        assertEquals("a", userService.getAvatar(1));
//        userService.updateAvatar(pre,1);
//        assertEquals(pre, userService.getAvatar(1));
//    }
//}